    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_type', models.ForeignKey(help_text='Business type cannot be deleted if companies are using it', on_delete=django.db.models.deletion.PROTECT, related_name='companies', to='core.businesstype', verbose_name='Business Type')),
