    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_type', models.ForeignKey(help_text='Business type cannot be deleted if companies are using it', on_delete=django.db.models.deletion.PROTECT, related_name='companies', to='tenants.businesstype', verbose_name='Business Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(db_index=True, default=False, verbose_name='Is Deleted')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Deleted At')),
                ('role_level', models.IntegerField(choices=[(1, 'Basic User'), (2, 'Staff'), (3, 'Manager'), (4, 'Administrator')], default=1, help_text='Employee role level (1-4). Owner is not an employee.', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(4)], verbose_name='Role Level')),
