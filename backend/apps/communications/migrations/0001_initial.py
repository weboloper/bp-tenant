# Generated by Django 5.2.5 on 2026-01-21 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('sent', 'Sent'), ('delivered', 'Delivered'), ('failed', 'Failed'), ('read', 'Read'), ('rejected', 'Rejected')], default='pending', max_length=20, verbose_name='Status')),
                ('provider_name', models.CharField(blank=True, help_text='SMS provider name (e.g., netgsm, twilio)', max_length=50, verbose_name='Provider Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider_name', models.CharField(blank=True, help_text='Provider name (e.g., netgsm, sendgrid)', max_length=50, verbose_name='Provider Name')),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('sent', 'Sent'), ('delivered', 'Delivered'), ('failed', 'Failed'), ('read', 'Read'), ('rejected', 'Rejected')], default='pending', max_length=20, verbose_name='Status')),
                ('error_message', models.TextField(blank=True, verbose_name='Error Message')),
